...
public:
    ...
    {
        Image image = LoadImage("pic/food.png");
...
int main()
{
    ...
    while (WindowShouldClose() == false)
    {
        ...
        DrawText("Retro Snake", offset - 5, 20, 40, orange);
        DrawText(TextFormat("%i", game.score), offset - 5, offset + cellSize * cellCount + 10, 40, orange);
        game.Draw();
        EndDrawing();
    }
    CloseWindow();
